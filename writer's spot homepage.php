...
<!--head section-->
  ...
  <li><a href="landing1.html">Sign up</a></li>
  </div>
</ul>
...
<fieldset>
<div class="floating-box"><center><img src="avatar.png" style="width:15%;height:15%"/><h3 style="color:green;font-family:'Comic Sans MS', cursive, serif;text-shadow: 2px 2px black;">Writers</h3></center><p style="font-size:14px;font-family: Arial, Helvetica, sans-serif;">Writer's Spot is currently hiring new writers.Writer's Spot is proving to be the best writing platform offering freelance writers with best opportunities to turn their writing skills to a stable income.</br>Sign up using the link below.</br><div class="tooltip"><a href="landing1.html">Sign up</a><span class="tooltiptext">Sign up for account</span> </div></p> </div></hr>
<div class="floating-box"><center><img src="avatar.png" style="width:15%;height:15%" /><h3 style="color:green;font-family:'Comic Sans MS', cursive, serif;text-shadow: 2px 2px black;">Employers</h3></center><p style="font-size:14px;font-family: Arial, Helvetica, sans-serif;">You dont have time to waste!Thousandths of freelance writers are on stage waiting for you to post your work.The process is just the simpliest.Post a job, get it done and pay out.</hr>Post your job using the link below<div class="tooltip"><a href="post.html">Post A job</a><span class="tooltiptext">Post your work now</span></div></div>
</fieldset>
</div>
...
<h1>
    <h3 style="color:white;font-family:'Comic Sans MS', cursive, serif;text-shadow: 2px 2px orange;">Contact us</h3>

             Your email:</br>
                   <input type="email" required placeholder="email..."> </br>
             Message:</br>
       <textarea name="comments" cols="15" rows="2"></textarea> </br>
     <a href="mailto:writer'sspot@gmail.com"><button>Send</button></br></a>
 ...
 <center>
<p><img src="facebook.png" alt="facebook"><img src="twitter_002.png" alt="twiter"><img src="linkedin.png" alt="linkedin"><img src="instagram.png" alt="instagram"></p>
